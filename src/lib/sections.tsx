...
// Every app section as a window definition. `nav` marks the ones that appear in the top
// bar (in this order); `view` is the permission key. Sections without `nav` (forex, orders)
// have routes and can be opened by URL/deep-link but aren't shown as top-bar tabs.
