...
import type { Adjustment, CreateAdjustmentDto, TransferStockDto } from './dtos';
...
export const adjustmentsApi = {
  ...
  transfer: (dto: TransferStockDto) => api.post<{ ok: boolean; items: number }>('/adjustments/transfer', dto),
